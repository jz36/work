<?
#Новости#0
#param#news_max;Максимальное количество хранящихся в базе новостей;100#kfp;Количество новостей на странице;20#
...
# =======================================
	...
	if (isset($id) || isset($add) || isset($edit)) {
		$ed=new edit();
		$ed->input_names=array("data");
		$ed->input_komments=array("Дата:");
		$ed->input_komments2=array("(В формате дд.мм.гг)");		
		$ed->input_types=array("text2");
