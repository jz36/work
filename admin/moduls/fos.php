...
# =======================================
	...
	if (isset($add) || isset($id)) {
		...
		$tps1="input,,Текстовая поле - 1 строка#textarea,,Текстовое поле - несколько строк#select,,Выпадающий список#select2,,Мультиселекторный список#text,,Текстовый блок (не поле)#data,,Дата#div,,Разделитель формы#password,,Пароль#password2,,Проверка пароля#email,,E-mail";
