...
function banners_main($num,$pref) {
...
if (!empty($r["content"])){
	$content=$r["content"];
	if (!empty($r["url"])) {
		$link_go="<a href='".PATH.SPAGE."?main=".$table."&id=".$r["id"]."' ".$target." style='color:#01299B'>Перейти &raquo;</a>"; 
	}
	else $link_go="";
}
...
?>
		<div class="banner">
		<table cellpadding=0 cellspacing=0 border=0 class=tableno>
		<tr>
